...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out1, relu_cache = affine_relu_forward(out, W2, b2)
        scores, out_cache = affine_forward(out1, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dh, dW3, grads['b3'] = affine_backward(dout, out_cache)
        grads['W3'] = dW3 + self.reg * W3        
        df, dW2, grads['b2'] = affine_relu_backward(dh, relu_cache)
        grads['W2'] = dW2 + self.reg * W2
        dx, dW1, grads['b1'] = conv_relu_pool_backward(df, pool_cache)
