...
def rmsprop(x, dx, config=None):
    ...
    # config['cache'].                                                        #
    ###########################################################################
    config['cache'] = config['decay_rate'] * config['cache'] + (1 - config['decay_rate']) * np.multiply(dx,dx)
    next_x = x - np.multiply(config['learning_rate'],dx) / (np.sqrt(config['cache']) + config['epsilon'])
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def adam(x, dx, config=None):
    ...
    v = beta2 * v + (1 - beta2) * np.multiply(dx,dx)
